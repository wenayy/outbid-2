        ...
        {heroStep === "input" ? (
          <div className="flex gap-2">
            <div className="flex-1 relative">
              <svg className="absolute left-3 top-1/2 -translate-y-1/2 text-gh-text-muted" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-gh-canvas border border-gh-border rounded-md text-sm text-gh-text placeholder-gh-text-muted focus:outline-none focus:border-gh-blue focus:ring-1 focus:ring-gh-blue/30 transition-all duration-200"
              />
            </div>
            <button
              onClick={heroLookup}
